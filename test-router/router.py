...
# socket to clients (client connects to this)
router_send = socket.socket() 
router_send.bind(("localhost", 8200))

# router MAC
router_mac = "05:10:0A:CB:24:EF"

# client IPs and MACs for ARP tables
...
# router listens for client connections
...
# router connects to server when all clients connected
server = ("localhost", 8000)
router.connect(server) 

# while connected to server, receives frames
while True:
    ...
    # referring to ARP tables, forwards frame to next socket
